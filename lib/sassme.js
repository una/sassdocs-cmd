...
program
  ...
  .option('nesting', 'Some examples of nesting')
...
// get the arguments, minus node
	...
	else if (args == 'variables' || args == "vars") {
	...
	else if (args.indexOf('string','strings') == 0) {
	...
	else if (args == 'function' || args == "functions") {
